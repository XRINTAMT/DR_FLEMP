...
public class AnimationMovementB12 : MonoBehaviour
{
    ...
    public bool onPlace;
    bool rotate;
    public bool animTest1;
    public bool animTest2;
    public bool animTest3;
    int stopPointIndex;
    ...
    public void AnimationPutOnPulse()
    {
        ...
        FindObjectOfType<SensorControllerB12>(true).sensorAnimation = true;
        onPlace = false;
        indexPoint = 0;
        stopPointIndex = 0;
    }
    public void AnimationThermometer()
    {
        //animator.applyRootMotion = true;
        animator.SetTrigger("StandUp");
        FindObjectOfType<SensorControllerB12>(true).thermometerAnimation = true;
        onPlace = false;
        indexPoint = 0;
        stopPointIndex = 0;
    }
    public void AnimationBloodPressure()
    {
        //animator.applyRootMotion = true;
        animator.SetTrigger("StandUp");
        FindObjectOfType<SensorControllerB12>(true).bloodPressureAnimation = true;
        onPlace = false;
        indexPoint = 0;
        stopPointIndex = 0;
    }
